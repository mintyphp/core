...
class Orm
{
     ...
     * @var array<string, ?string> $object
     */
    public static function update(string $tableName, array $object, int $id, string $idField = 'id'): int
    {
     ...
     */
    public static function select(string $tableName, int $id, string $idField = 'id'): array
    {
